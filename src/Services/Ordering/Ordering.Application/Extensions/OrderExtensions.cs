namespace eCommerceMicroservicesV2.Ordering.Application.Extensions;

public static class OrderExtensions
{
    // To map Orders to OrderDtos
    ...
    public static OrderDto ToOrderDto(this Order order)
    {
        return new OrderDto(
                    ...
                    Payment: 
                        new PaymentDto
                        (order.Payment.CardName!, order.Payment.CardNumber, order.Payment.Expiration, 
