...
using eCommerceMicroservicesV2.Ordering.Application.Orders.Commands;
using eCommerceMicroservicesV2.Ordering.Domain.Enums;
using MassTransit;

namespace eCommerceMicroservicesV2.Ordering.Application.Orders.EventHandlers.Integration;
    ...
    : IConsumer<BasketCheckoutEvent>
{
    ...
    {
        logger.LogInformation(Messages.GetIntegrationEventMessage(context.Message.GetType().Name));
    ...
    {
        // Create complete order with incoming event data
        var addressDto = 
            new AddressDto(
